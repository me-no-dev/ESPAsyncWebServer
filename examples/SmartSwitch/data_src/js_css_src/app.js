var tpick = {
    attach: function (target) {
		...
		var dig = document.getElementById(target).value.split(":");
	    var t1 = dig[0] || "23";
		var t2 = dig[1] || "59";
        ...
        tp.appendChild(this.draw("h",t1));
        tp.appendChild(this.draw("m",t2));
    ...
    set: function (el) {
        ...
        var time = input[0].value + ":" + input[1].value;
...
var fpick = {
    attach: function (target) {
		...
		var t2 = dig[1] || "2";
        var uniqueID = 0;
        while (document.getElementById("fpick-" + uniqueID) != null) {
            uniqueID = Math.floor(Math.random() * (100 - 2)) + 1;
        }
        var tw = document.createElement("div");
        tw.id = "fpick-" + uniqueID;
        tw.classList.add("tpop");
        tw.dataset.target = target;
        tw.addEventListener("click", function (evt) {
            if (evt.target.classList.contains("tpop")) {
        ...
        bottom.classList.add("fpicker-btn");
        bottom.appendChild(ok);
        tp.appendChild(bottom);
        tw.appendChild(tp);
        document.body.appendChild(tw);
        ...
        target.dataset.dp = uniqueID;
        target.onfocus = function () {
            document.getElementById("fpick-" + this.dataset.dp).classList.add("show");
        };
    },
    draw: function (type,tv) {
        ...
        down = document.createElement("div"),
        text = document.createElement("input");
        docket.classList.add("fpicker-" + type);
        up.classList.add("fpicker-up");
        down.classList.add("fpicker-down");
        up.innerHTML = "&#65087;";
        down.innerHTML = "&#65088;";
        text.readOnly = true;
        text.setAttribute("type", "text");
    ...
    set: function (el) {
        ...
        var input = parent.querySelectorAll("input[type=text]");
        var temperature = input[0].value + "." + input[1].value;
        document.getElementById(parent.dataset.target).value = temperature;
        parent.classList.remove("show");
    }
};
!function (t) {
...
([function (t, n, e) {
            ...
            !function (t) {
                ...
                function r(t) {
                    ...
                    return n || (n = (0, o.createElement)("div", "ncf-container", t), (0, o.append)(document.body, n)),
                    n
                }
                var c = {
                    closeOnClick: !0,
...
(this, function () {
    ...
    j = function (c, d) {
        ...
        for (var p = 0, q = i.length; q > p; p++)
            "zIndex" in i[p] && (l.push(i[p].zIndex), i[p].zIndex < 0 && (m[i[p].zIndex] = i[p]));
        for (l.sort(h); l[k] < 0; )
    ...
    j.on = function (a, b) {
        ...
        for (var c = a.split(e), d = i, f = 0, h = c.length; h > f; f++)
            d = d.n, d = d.hasOwnProperty(c[f]) && d[c[f]] || (d[c[f]] = {
                        n: {}
                    });
...
(this, function (a) {
    ...
    function j(a, b, c, d, e, f, g, h, j) {
        if (!(0 > j || i(a, b, c, d, e, f, g, h) < j)) {
            ...
            for (k = i(a, b, c, d, e, f, g, h, n); P(k - j) > o; )
                m /= 2, n += (j > k ? 1 : -1) * m, k = i(a, b, c, d, e, f, g, h, n);
            return n
        }
    }
    ...
    function l(a, c, d) {
        ...
        for (q = 0; l + 1 > q; q++)
            r = b.findDotsAtSegment.apply(b, c.concat(q / l)), n.push({
                x: r.x,
                y: r.y,
                t: q / l
            });
        ...
        if (i) {
            if (j)
                ...
                for (var z in i)
                    if (i[y](z) && (ca[y](z) || d.paper.customAttributes[y](z)))
                        ...
                        case "csv":
                            ...
                            break;
                        default:
                            for (M = [][D](i[z]), N = [][D](r[z]), t[z] = [], w = d.paper.customAttributes[z].length; w--; )
                                t[z][w] = ((M[w] || 0) - (N[w] || 0)) / q
                        }
                var O = i.easing,
                ...
                if (o = i.start || c.start || +new Date, u = {
                        ...
                        origin: d.attr(),
                        totalOrigin: g
                    }, fb.push(u), f && !j && !k && (u.stop = !0, u.start = new Date - q * f, 1 == fb.length))
                    return hb();
    ...
    if (b._g = z, b.type = z.win.SVGAngle || z.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML", "VML" == b.type) {
        ...
        if (ra.innerHTML = '<v:shape adj="1"/>', qa = ra.firstChild, qa.style.behavior = "url(#default#VML)", !qa || "object" != typeof qa.adj)
            return b.type = F;
        ra = null
    }
    ...
    wa = function (a, c, d) {
        ...
        return (a > 1 || c > 1 || d > 1) && (a /= 255, c /= 255, d /= 255),
        [a, c, d]
    },
    xa = function (a, c, d, e) {
        a *= 255,
    ...
    b.hsb2rgb = function (a, b, c, d) {
        this.is(a, "object") && "h" in a && "s" in a && "b" in a && (c = a.b, b = a.s, d = a.o, a = a.h),
        a *= 360;
        var e,
        f,
        g,
    ...
    b.getColor = function (a) {
        ...
        return b.h += .075,
        b.h > 1 && (b.h = 0, b.s -= .2, b.s <= 0 && (this.getColor.start = {
                    h: 0,
                    s: 1,
                    b: b.b
                })),
    ...
    b.parsePathString = function (a) {
        ...
        e.length || H(a).replace(ga, function (a, b, c) {
            ...
            if (c.replace(ia, function (a, b) {
                    b && f.push(+b)
                }), "m" == g && f.length > 2 && (e.push([b][D](f.splice(0, 2))), g = "l", b = "m" == b ? "l" : "L"), "r" == g)
                e.push([b][D](f));
            else
    ...
    Ca = b._pathToAbsolute = function (a) {
        ...
        if (c.abs)
            return Aa(c.abs);
        if (b.is(a, U) && b.is(a && a[0], U) || (a = b.parsePathString(a)), !a || !a.length)
            return [["M", 0, 0]];
        var d = [],
        e = 0,
        f = 0,
        ...
        for (var k, l, m = 3 == a.length && "M" == a[0][0] && "R" == a[1][0].toUpperCase() && "Z" == a[2][0].toUpperCase(), n = j, o = a.length; o > n; n++) {
            if (d.push(k = []), l = a[n], l[0] != aa.call(l[0]))
                ...
                p = [e, f][D](l.slice(1)), d.pop(), d = d[D](g(p, m)), k = ["R"][D](l.slice(-2));
            else
            ...
            for (var d = Ca(a), e = b && Ca(b), f = {
                ...
                if (a[b].length > 7) {
                    ...
                    for (var c = a[b]; c.length; )
                        k[b] = "A", e && (l[b] = "A") , a.splice(b++, 0, ["C"][D](c.splice(0, 6)));
                        a.splice(b, 1),
    ...
    Ja = (b._parseDots = e(function (a) {
                for (var c = [], d = 0, e = a.length; e > d; d++) {
                    var f = {},
                    g = a[d].match(/^([^:]*):?([\d\.]*)/);
                    if (f.color = b.getRGB(g[1]), f.color.error)
                        return null;
    ...
    Na = b._equaliseTransform = function (a, c) {
        ...
        for (var d, e, f, g, h = N(a.length, c.length), i = [], j = [], k = 0; h > k; k++) {
            if (f = a[k] || Ma(c[k]), g = c[k] || Ma(f), f[0] != g[0] || "r" == f[0].toLowerCase() && (f[2] != g[2] || f[3] != g[3]) || "s" == f[0].toLowerCase() && (f[3] != g[3] || f[4] != g[4]))
                return;
            for (i[k] = [], j[k] = [], d = 0, e = N(f.length, g.length); e > d; d++)
    ...
    function (a) {
        ...
        a.split = function () {
            ...
            var f = -e[0][1],
            g = e[1][1];
            return 0 > g ? (a.rotate = b.deg(M.acos(g)), 0 > f && (a.rotate = 360 - a.rotate)) : a.rotate = b.deg(M.asin(f)),
    ...
    Xa.removeData = function (a) {
        return null == a ? ja[this.id] = {}
         : ja[this.id] && delete ja[this.id][a],
        this
    },
    Xa.getData = function () {
        return c(ja[this.id] || {})
    ...
    Xa.undrag = function () {
        for (var c = Za.length; c--; )
            Za[c].el == this && (this.unmousedown(Za[c].start), Za.splice(c, 1), a.unbind("raphael.drag.*." + this.id));
            ...
            for (var g, h, i, j, k, l = "", m = {}, n = 0, o = 0, p = d.length; p > o; o++) {
                if (i = d[o], "M" == i[0])
                    ...
                    if (j = _a(g, h, i[1], i[2], i[3], i[4], i[5], i[6]), n + j > e) {
                        if (c && !m.start) {
                            if (k = _a(g, h, i[1], i[2], i[3], i[4], i[5], i[6], e - n), l += ["C" + k.start.x, k.start.y, k.m.x, k.m.y, k.x, k.y], f)
                                return l;
                            m.start = l,
                    ...
                    if (i > h) {
                        ...
                        for (var s in k)
                            if (k[y](s)) {
                                ...
                                default:
                                    var z = [][D](k[s]);
                                    for (f = [], t = n.paper.customAttributes[s].length; t--; )
                                        f[t] = +z[t] + q * i * l[s][t]
                                }
                                o[s] = f
                            }
    ...
    b.animation = function (a, c, d, e) {
        ...
        if (f)
            return d && (h.easing = d), e && (h.callback = e), new q({
                100: h
            }, c);
        if (e) {
            var i = 0;
    ...
    var jb = function (a) {
        if (this.items = [], this.length = 0, this.type = "set", a)
            for (var b = 0, c = a.length; c > b; b++)
                !a[b] || a[b].constructor != Xa.constructor && a[b].constructor != jb || (this[this.items.length] = this.items[this.items.length] = a[b], this.length++)
    },
    kb = jb.prototype;
    kb.push = function () {
...
(this, function (a) {
    if (!a || a.svg) {
        ...
        t = function (d, e, f) {
            if ("path" == d.type) {
                ...
                if ("open" == w ? (x += 2, y += 2, z += 2, i = 1, j = f ? 4 : 1, k = {
                    ...
                    f ? (g = d._.arrows.startdx * u || 0, h = a.getTotalLength(t.path) - g) : (g = 0, h = a.getTotalLength(t.path) - (d._.arrows.enddx * u || 0)), d._.arrows[r + "Path"] && q(s, {
        ...
        a._engine.create = function () {
            ...
            1 == c ? (i.style.cssText = j + "position:absolute;left:" + d + "px;top:" + e + "px", a._g.doc.body.appendChild(i), h = 1) : (i.style.cssText = j + "position:relative", c.firstChild ? c.insertBefore(i, c.firstChild) : c.appendChild(i)),
            c = new a._Paper,
            c.width = f,
            c.height = g,
            c.canvas = i,
...
(this, function (a) {
    if (!a || a.vml) {
        ...
        E.transform = function (b) {
            ...
            return null !== d && (this._.transform = d, a._extractTransform(this, d)),
            this
        },
        ...
        a._engine.setViewBox = function (b, c, d, e, f) {
            ...
            j = i.width,
            k = i.height;
            return f && (g = k / e, h = j / d, j > d * g && (b -= (j - d * g) / 2 / g), k > e * h && (c -= (k - e * h) / 2 / h)),

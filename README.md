...
- **ESP32 with AsyncTCP**: `mathieucarbou/AsyncTCP @ 3.2.11`
  Arduino IDE: [https://github.com/mathieucarbou/AsyncTCP#v3.2.11](https://github.com/mathieucarbou/AsyncTCP/releases)
...
With `mathieucarbou/AsyncTCP @ 3.2.11`

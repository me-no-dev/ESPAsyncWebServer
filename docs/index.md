...
- **ESP32 with AsyncTCP**: `mathieucarbou/AsyncTCP @ 3.2.13`
  Arduino IDE: [https://github.com/mathieucarbou/AsyncTCP#v3.2.13](https://github.com/mathieucarbou/AsyncTCP/releases)
...
With `mathieucarbou/AsyncTCP @ 3.2.13`

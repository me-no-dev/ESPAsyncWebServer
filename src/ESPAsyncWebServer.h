...
class AsyncWebServerRequest {
  ...
  private:
    ...
    stringarray::LinkedList<AsyncWebHeader *> _headers;
    stringarray::LinkedList<AsyncWebParameter *> _params;
    stringarray::LinkedList<String *> _pathParams;
...
class AsyncWebServer {
  protected:
    AsyncServer _server;
    stringarray::LinkedList<AsyncWebRewrite*> _rewrites;
    stringarray::LinkedList<AsyncWebHandler*> _handlers;
...
class DefaultHeaders {
  using headers_t = stringarray::LinkedList<AsyncWebHeader *>;
  headers_t _headers;

...
bool SPIFFSEditor::canHandle(AsyncWebServerRequest *request){
  if(request->url().equalsIgnoreCase("/edit")){
    ...
    else if(request->method() == static_cast<uint8_t>(WebRequestMethod::HTTP_POST))
      return true;
    else if(request->method() == static_cast<uint8_t>(WebRequestMethod::HTTP_DELETE))
      return true;
    else if(request->method() == static_cast<uint8_t>(WebRequestMethod::HTTP_PUT))
      return true;
